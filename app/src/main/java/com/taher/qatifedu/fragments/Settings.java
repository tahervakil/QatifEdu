...
/*  private ArrayList<Section_Company_Entity> alSection_CompanyDataMain;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
    ...
    tb_sound.setChecked(act.getSharedPreferences("sound", Context.MODE_PRIVATE)
			.getBoolean("isSoundOn", true));
    tb_sound.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		public void onCheckedChanged(CompoundButton buttonView,
				boolean isChecked) {
			act.getSharedPreferences("sound", Context.MODE_PRIVATE).edit()
					.putBoolean("isSoundOn", isChecked).commit();}});
