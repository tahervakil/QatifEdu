...
public class News extends /*Sherlock*/Fragment
 {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
	...
	griddview.setOnItemClickListener(new OnItemClickListener() {
	@Override
  ...
  public void ScrollRight(final HorizontalScrollView v){
	  new CountDownTimer(2000, 20) { 
	      ...
	      public void onTick(long millisUntilFinished) { 
	          if((2000 - millisUntilFinished)==v.getRight())
  ...
  public class GridViewCustomAdapter extends ArrayAdapter<Object>
  {
       ...
       {
    	   if (alSectionsMainDataList== null || alSectionsMainDataList.size() == 0)
   			return  convertView; 
  		...
  		if (section != null && section.getName() != null)
  			tv_title.setText(section.getName());
  		 
  		String strCount=Integer.toString(section.getUnread());
  		if(strCount.equals("0"))
  			tv_unread.setVisibility(View.GONE);
  		else
  		tv_unread.setText(Integer.toString(section.getUnread()));
  		...
  		try {
  		   if(section != null && section.getLogo() != null){
       	    imageLoader.displayImage(act.getString(R.string.section_image_url) + section.getLogo(),iv_image, options, new SimpleImageLoadingListener() {
  				@Override
  				public void onLoadingStarted(String imageUri, View view) {
