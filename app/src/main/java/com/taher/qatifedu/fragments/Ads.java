...
public class Ads extends Fragment
 {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
	...
	.getDefaultDisplay();
     ...
     layout = (HorizontalScrollView)myFragmentView.findViewById(R.id.scroll_layout);
	...
	@Override
		...
		if (alCompaniesMainDataList != null && alCompaniesMainDataList.get(position) != null ) {
	 ...
	 ((TextView) actionBar.getSupportActionBar().getCustomView().findViewById(R.id.tvTitle)).setText(name);
  ...
  private Cursor getTikerCursor() {
		Cursor crsr = null;
		try {
			String sql = String.format(Locale.US, "select %s,%s from %s order by %s DESC ", Constants.ID, Constants.TITLE, Constants.TIKERNEWS_TABLE," LastChange ");
			crsr = db.rawQuery(sql, null);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
  ...
  private class FetchCompanies_AdsData extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progress = ProgressDialog.show(actionBar, getString(R.string.pleaseWait), "", true, true, null);
...
private Runnable runnable = new Runnable() {
  ...
  public class GridViewCustomAdapter extends ArrayAdapter<Object>
  {
       ...
       public View getView(int position, View convertView, ViewGroup parent) 
       {
    	   ...
    	   LayoutInflater inf = (LayoutInflater)actionBar.getSystemService(actionBar.LAYOUT_INFLATER_SERVICE);
  		...
  		tv_unread.setOnClickListener(new OnClickListener() {
  		...
  		try {
  		   if(Company != null && Company.getLogo() != null){
       	    imageLoader.displayImage(actionBar.getString(R.string.companies_image_url) + Company.getLogo(),iv_image, options, new SimpleImageLoadingListener() {
  				@Override
  				public void onLoadingStarted(String imageUri, View view) {
  ...
  public void onResume(){
	((TextView) actionBar.getSupportActionBar().getCustomView().findViewById(R.id.tvTitle)).setText(name);
	((ImageButton) actionBar.getSupportActionBar().getCustomView().findViewById(R.id.btn_refreash)).setVisibility(View.GONE);
