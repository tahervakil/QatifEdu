...
public class Banner extends /*Sherlock*/Fragment  {
	...
	private Handler handler = new Handler(){
	 ...
	 public class ViewCountLoader extends AsyncTask<Void, Void, String>
		{	
			...
			{   
				if (Utility.isConnected(act)) {
					noofViews = new FetchApiResponse().getJsonValue("http://qatifedu.com/cmsQatifedu/Services/frmViews.aspx?id="+banner.getID()+"&type=3&addOne=1");
			...
			{   
				try{
				((TextView) myFragmentView.findViewById(R.id.tv_views)).setText(getString(R.string.views)+ " : " + v );}catch(Exception ex){}}}
