...
import com.taher.qatifedu.utility.MyWebView_AdsDetails;
...
public class Ads_Details extends /*Sherlock*/Fragment
 {
    static View myFragmentView;
    private SQLiteDatabase db;
	private DatabaseHelper dbHelper;
	private static ContentUpdater updater;
	private static MyWebView_AdsDetails webView = null;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
	...
	btn_Favorite.setOnClickListener(new OnClickListener() {
		...
		btn_Share.setOnClickListener(new OnClickListener() {	
		 ...
		 alAdsMainData=bundle.getParcelableArrayList("Ads");
