...
public class News_Entity  implements Parcelable{

	private String  id,section_id,title,text,image,views,startdate,enddate,lastchange,
	 lastchangetype;
	private int viewed,status=0,is_first=0;
	
	public News_Entity(Parcel in) { 
		readFromParcel(in); } 
