...
import com.taher.qatifedu.handler.ContentHandler_Event;
...
public class ContentParser {
  ...
  public ArrayList<More_Entity> getGeneralContents()
  ...
  public ArrayList<Event_Entity> getEventContents()
      throws ParserConfigurationException, SAXException, IOException {
    ArrayList<Event_Entity> contents = null;
    SAXParserFactory fac = SAXParserFactory.newInstance();
    SAXParser parser;
    try {
      ContentHandler_Event handler = new ContentHandler_Event();
      parser = fac.newSAXParser();
      InputStream istream = load(urlString, 60000, "GET");
      parser.parse(istream, handler);
      contents = handler.getContents();
  ...
  public ContactUs_Entity getContactUsContents()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<Section_Entity> getSectionContents()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<Company_Entity> getCompaniesContents()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<Banner_Entity> getBanners()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<TikerNews_Entity> getTikerNews()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<News_Entity> getNews()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<Ads_Entity> getAds()
      throws IOException, ParserConfigurationException, SAXException {
  ...
  public ArrayList<Sponsor_Entity> getSponsor()
      throws IOException, ParserConfigurationException, SAXException {
