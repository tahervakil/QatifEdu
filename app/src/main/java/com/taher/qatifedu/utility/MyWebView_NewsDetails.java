...
import com.taher.qatifedu.fragments.New_Details;
...
public class MyWebView_NewsDetails extends WebView {
    private boolean flinged;
    private static final int SWIPE_MIN_DISTANCE = 320;
    private static final int SWIPE_MAX_OFF_PATH = 250;
    private static final int SWIPE_THRESHOLD_VELOCITY = 200;
    int pos;
    New_Details Fragment;
    public MyWebView_NewsDetails(Context context, AttributeSet attrs) {
        super(context, attrs);
       // gd = new GestureDetector(context, sogl);
    }
    
    public void setFragment(New_Details  Fragment){
