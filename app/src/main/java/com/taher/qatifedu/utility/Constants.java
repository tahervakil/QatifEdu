...
public class Constants {
    ...
    public static final String NEWS_FAVORITE_TABLE = "NewsFavorite";
    public static final String NUMVIED_TABLE = "NumViews";
    ...
    public static final String DETIALS = "Detials";
    public static final String DETAILS = "Details";
    public static final String PHONE = "Phone";
    public static final String EMAIL = "Email";
    public static final String FACEBOOK = "Facebook";
    public static final String TWITTER = "Twitter";
    public static final String INSTEGRAM = "Instegram";
    ...
    public static final String MADEYEAR = "MadeYear";
    ...
    public static final String FILE_NAME3 = "File_Name3";
    public static final String FILE_NAME4 = "File_Name4";
    ...
    public static final String NUMVIEWD = "NumViewd";
