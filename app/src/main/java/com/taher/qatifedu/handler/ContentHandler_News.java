...
public class ContentHandler_News extends DefaultHandler {
	...
	private ArrayList<News_Entity> contents;
	private StringBuilder sb;
	private News_Entity currentContent;
	...
	public void startDocument() throws SAXException {
		...
		contents = new ArrayList<News_Entity>();
	}
	...
	public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
		...
		if (localName.equalsIgnoreCase(record)) {
			currentContent = new News_Entity();
		}
	}

	public ArrayList<News_Entity> getContents() {
		return contents;
	}
}
